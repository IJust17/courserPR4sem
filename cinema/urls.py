...
urlpatterns = [
    ...
    path('moderation/reviews/<int:pk>/approve/',
         views.ReviewApproveView.as_view(), name='review-approve'),
    path('reviews/<int:pk>/delete/', views.ReviewDeleteView.as_view(),
         name='review-delete'),
    ...
    path('admin-users/<int:pk>/toggle-staff/',
         views.ToggleStaffView.as_view(), name='user-toggle-staff'),
    ...
    path('accounts/register/', views.SignUpView.as_view(),
         name='register'),
